...
## Teste cria_base_intermediaria_fapesp

test_that("testa a função cria_base_intermediaria_fapesp() com um dataset gabarito",
          {
            df_test <- data.frame(
            ...
            expect_match(cria_base_intermediaria_fapesp() %>% str(),
                         df_test %>% str)
          })
