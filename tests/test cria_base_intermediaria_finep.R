...
## Teste cria_base_intermediaria_finep

test_that("testa a função cria_base_intermediaria_finep() com um dataset gabarito",
          {
            df_test <- data.frame(
            ...
            expect_match(cria_base_intermediaria_finep() %>% str(),
                         df_test %>% str)
          })
