...
## Teste cria_base_intermediaria_cnpq

test_that("testa a função cria_base_intermediaria_cnpq() com um dataset gabarito",
          {
            df_test <- data.frame(
            ...
            expect_match(cria_base_intermediaria_cnpq() %>% str(),
                         df_test %>% str)
          })
