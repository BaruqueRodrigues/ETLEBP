...
## Teste cria_base_intermediaria_bndes

test_that("testa a função cria_base_intermediaria_bndes() com um dataset gabarito",
          {
            df_test <- data.frame(
            ...
            expect_match(cria_base_intermediaria_bndes() %>% str(),
                         df_test %>% str)
          })
