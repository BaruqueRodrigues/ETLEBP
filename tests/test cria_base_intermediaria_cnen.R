...
## Teste cria_base_intermediaria_cnen

test_that("testa a função cria_base_intermediaria_cnen() com um dataset gabarito",
          {
            df_test <- data.frame(
            ...
            expect_match(cria_base_intermediaria_cnen() %>% str(),
                         df_test %>% str)
          })
